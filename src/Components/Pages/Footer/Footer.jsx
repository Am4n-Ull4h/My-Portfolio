  ...
  return (
    <Fragment>
      ...
      <div className='flex justify-end gap-2 items-center mt-16'>
        ...
        <h1 className='text-[60px] font-extrabold text-center mt-10 text-gray-700'>Ready to bring your <span className='font-extralight'>ideas to <br /></span> life?</h1>
        <h1 className='text-[60px] font-extrabold  text-center text-gray-700'>I'm <span className='font-extralight'>here to help</span></h1>
        <button className='flex items-center w-[20%] py-5 text-[20px] rounded-full mx-auto justify-center gap-5 mt-10 bg-orange-500'>Contact Me <span className='p-3 bg-black text-white rounded-full'><CiLocationArrow1/></span></button>
        ...
        <div className='Header_Main mt-10' id='contact'>
           <div className="w-[80%] mx-auto py-20 text-white">
            ...
            <div className='flex mt-12 justify-between items-center'>
                ...
                <button className='flex items-center w-[30%] py-3 text-[20px] rounded-full  justify-center gap-5  bg-orange-500'>Send Message <span className='p-3 bg-black text-white rounded-full'><CiLocationArrow1/></span></button>
            ...
            <div className='flex w-[80%] justify-between mx-auto mt-16'>
                <div className='w-[30%]'>
                    <Link to='/' className='text-[50px] font-extrabold'>Aman .</Link>
